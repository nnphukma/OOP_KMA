...
class XeMay extends PhuongTien {
    double cong_suat_dong_co;
    
    public XeMay(String name, String brand, int manufature_date, int maxspeed, double congsuatdongco){
        super(name, brand, manufature_date, maxspeed);
        this.cong_suat_dong_co = congsuatdongco;
    }
    
    @Override
    public String toString(){
        return super.toString() + 
                "\nCong suat dong co: " + cong_suat_dong_co;
    }
}
